...
@Component({
  selector: 'app-bidder-overview-component',
  imports: [ CommonModule, BidderModalBidComponent ],
  templateUrl: './bidder-overview-component.html',
  styleUrl: './bidder-overview-component.scss'
})
export class BidderOverviewComponent implements OnInit{
  user!: User
 auctions: Auction[] = [];
